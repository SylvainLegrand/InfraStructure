...
#subtotal-summary-floating #subtotal-summary-let-menu-contaner {
	display: none;
	position: absolute;
	right: 0;
	bottom: 60px;
...
#subtotal-summary-floating.--open #subtotal-summary-let-menu-contaner {
	display: block;
	transform: translateY(0);
	opacity: 1;
}

#subtotal-summary-floating #subtotal-summary-title {
	position: sticky;
	top: 0;
	z-index: 1;
	padding: 12px 16px;
...
#subtotal-summary-floating .subtotal-summary-link {
	padding: 4px 16px;
	line-height: 1.8em;
	color: <?php echo $cssTxt; ?>;
...
#subtotal-summary-floating .subtotal-summary-link:hover {
	background: <?php echo $isOblyon ? $cssBgHover : 'color-mix(in srgb, '.$cssTxt.' 10%, transparent)'; ?>;
	color: <?php echo $cssTxtHover; ?>;
	text-decoration: none;
}

#subtotal-summary-floating .subtotal-summary-link.--target-in-viewport,
#subtotal-summary-floating .subtotal-summary-link.--child-in-viewport {
...
#subtotal-summary-floating #subtotal-summary-let-menu-contaner::-webkit-scrollbar {
	width: 6px;
}

#subtotal-summary-floating #subtotal-summary-let-menu-contaner::-webkit-scrollbar-thumb {
	background: color-mix(in srgb, <?php echo $cssTxt; ?> 25%, transparent);
	border-radius: 3px;
}

#subtotal-summary-floating #subtotal-summary-let-menu-contaner::-webkit-scrollbar-thumb:hover {
